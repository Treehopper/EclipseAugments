...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addChildProjectUrlInheritAppendPathPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__MODEL_VERSION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__GROUP_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__ARTIFACT_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__PACKAGING,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.MODEL__INCEPTION_YEAR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Child Project Url Inherit Append Path feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addChildProjectUrlInheritAppendPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_childProjectUrlInheritAppendPath_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_childProjectUrlInheritAppendPath_feature", "_UI_Model_type"),
				 PomPackage.Literals.MODEL__CHILD_PROJECT_URL_INHERIT_APPEND_PATH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PomPackage.Literals.MODEL__REPORTS);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__PARENT,
				 PomFactory.eINSTANCE.createParent()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__ORGANIZATION,
				 PomFactory.eINSTANCE.createOrganization()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__LICENSES,
				 PomFactory.eINSTANCE.createLicensesType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__DEVELOPERS,
				 PomFactory.eINSTANCE.createDevelopersType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__CONTRIBUTORS,
				 PomFactory.eINSTANCE.createContributorsType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__MAILING_LISTS,
				 PomFactory.eINSTANCE.createMailingListsType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__PREREQUISITES,
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__SCM,
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__CI_MANAGEMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__PROPERTIES,
				 PomFactory.eINSTANCE.createPropertiesType()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__DEPENDENCIES,
				 PomFactory.eINSTANCE.createDependenciesType2()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__REPOSITORIES,
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__BUILD,
				 PomFactory.eINSTANCE.createBuild()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__REPORTS,
				 PomFactory.eINSTANCE.createReportsType2()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__REPORTING,
				 PomFactory.eINSTANCE.createReporting()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.MODEL__PROFILES,
				 PomFactory.eINSTANCE.createProfilesType()));
	}
