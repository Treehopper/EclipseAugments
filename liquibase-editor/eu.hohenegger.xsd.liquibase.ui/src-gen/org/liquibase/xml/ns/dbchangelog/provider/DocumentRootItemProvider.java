...
public class DocumentRootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getDocumentRoot_Empty());
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getDocumentRoot_Output());
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getDocumentRoot_RenameSequence());
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getDocumentRoot_SetColumnRemarks());
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getDocumentRoot_SetTableRemarks());
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getDocumentRoot_Empty(),
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getDocumentRoot_Output(),
				 DbchangelogFactory.eINSTANCE.createOutputType()));

		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getDocumentRoot_Param(),
				 DbchangelogFactory.eINSTANCE.createParamType1()));
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getDocumentRoot_RenameSequence(),
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getDocumentRoot_SetColumnRemarks(),
				 DbchangelogFactory.eINSTANCE.createSetColumnRemarksType()));

		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getDocumentRoot_SetTableRemarks(),
