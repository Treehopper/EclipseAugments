...
public class ChangeSetTypeItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addRunOrderPropertyDescriptor(object);
		}
	...
	protected void addCreatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChangeSetType_created_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChangeSetType_created_feature", "_UI_ChangeSetType_type"),
				 DbchangelogPackage.eINSTANCE.getChangeSetType_Created(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIgnorePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChangeSetType_ignore_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChangeSetType_ignore_feature", "_UI_ChangeSetType_type"),
				 DbchangelogPackage.eINSTANCE.getChangeSetType_Ignore(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChangeSetType_labels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChangeSetType_labels_feature", "_UI_ChangeSetType_type"),
				 DbchangelogPackage.eINSTANCE.getChangeSetType_Labels(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Run Order feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addRunOrderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChangeSetType_runOrder_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChangeSetType_runOrder_feature", "_UI_ChangeSetType_type"),
				 DbchangelogPackage.eINSTANCE.getChangeSetType_RunOrder(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChangeSetType.class)) {
			...
			case DbchangelogPackage.CHANGE_SET_TYPE__IGNORE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getChangeSetType_ChangeSetChildren(),
				 FeatureMapUtil.createEntry
					(DbchangelogPackage.eINSTANCE.getChangeSetType_RenameSequence(),
					 DbchangelogFactory.eINSTANCE.createRenameSequenceType())));
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getChangeSetType_ChangeSetChildren(),
				 FeatureMapUtil.createEntry
					(DbchangelogPackage.eINSTANCE.getChangeSetType_SetTableRemarks(),
					 DbchangelogFactory.eINSTANCE.createSetTableRemarksType())));

		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getChangeSetType_ChangeSetChildren(),
				 FeatureMapUtil.createEntry
					(DbchangelogPackage.eINSTANCE.getChangeSetType_SetColumnRemarks(),
					 DbchangelogFactory.eINSTANCE.createSetColumnRemarksType())));
		...
		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getChangeSetType_ChangeSetChildren(),
				 FeatureMapUtil.createEntry
					(DbchangelogPackage.eINSTANCE.getChangeSetType_Output(),
					 DbchangelogFactory.eINSTANCE.createOutputType())));

		newChildDescriptors.add
			(createChildParameter
				(DbchangelogPackage.eINSTANCE.getChangeSetType_ChangeSetChildren(),
				 FeatureMapUtil.createEntry
					(DbchangelogPackage.eINSTANCE.getChangeSetType_Empty(),
					 DbchangelogFactory.eINSTANCE.createEmptyType())));
