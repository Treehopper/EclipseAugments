 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.MergeColumnsTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MergeColumnsTypeImpl extends MinimalEObjectImpl.Container implements MergeColumnsType {
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.MERGE_COLUMNS_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DbchangelogPackage.MERGE_COLUMNS_TYPE__ANY_ATTRIBUTE:
