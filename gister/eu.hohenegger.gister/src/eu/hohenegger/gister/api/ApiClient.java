...
import eu.hohenegger.gister.impl.JSON;
import eu.hohenegger.gister.impl.Pair;
import eu.hohenegger.gister.impl.RFC3339DateFormat;
import eu.hohenegger.gister.impl.StringUtil;
import eu.hohenegger.gister.impl.auth.ApiKeyAuth;
import eu.hohenegger.gister.impl.auth.Authentication;
import eu.hohenegger.gister.impl.auth.HttpBasicAuth;
import eu.hohenegger.gister.impl.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2019-08-16T08:33:00.108Z[GMT]")public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://api.github.com";
  ...
  public ApiClient() {
    ...
    authentications.put("bearerJwt", new OAuth());
    authentications.put("githubOAuth", new OAuth());
