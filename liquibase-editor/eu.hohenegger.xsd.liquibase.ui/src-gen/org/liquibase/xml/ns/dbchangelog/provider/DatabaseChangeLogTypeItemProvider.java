...
public class DatabaseChangeLogTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DatabaseChangeLogType_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DatabaseChangeLogType_context_feature", "_UI_DatabaseChangeLogType_type"),
				 DbchangelogPackage.eINSTANCE.getDatabaseChangeLogType_Context(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((DatabaseChangeLogType)object).getContext();
