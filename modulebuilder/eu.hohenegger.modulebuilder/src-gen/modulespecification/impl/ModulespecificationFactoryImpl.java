...
public class ModulespecificationFactoryImpl extends EFactoryImpl implements ModulespecificationFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ModulespecificationPackage.OS_GI_SEGMENT:
				return createOSGiSegmentFromString(eDataType, initialValue);
			case ModulespecificationPackage.OS_GI_NAME:
				return createOSGiNameFromString(eDataType, initialValue);
			case ModulespecificationPackage.MANDATORY_STRING:
				return createMandatoryStringFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case ModulespecificationPackage.OS_GI_SEGMENT:
				return convertOSGiSegmentToString(eDataType, instanceValue);
			case ModulespecificationPackage.OS_GI_NAME:
				return convertOSGiNameToString(eDataType, instanceValue);
			case ModulespecificationPackage.MANDATORY_STRING:
				return convertMandatoryStringToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public String createOSGiSegmentFromString(EDataType eDataType, String initialValue) {
		return (String)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertOSGiSegmentToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
	 ...
	 * @generated
	 */
	public String createOSGiNameFromString(EDataType eDataType, String initialValue) {
		return (String)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertOSGiNameToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
	 ...
	 * @generated
	 */
	public String createMandatoryStringFromString(EDataType eDataType, String initialValue) {
		return (String)super.createFromString(eDataType, initialValue);
	}
	 ...
	 * @generated
	 */
	public String convertMandatoryStringToString(EDataType eDataType, Object instanceValue) {
		return super.convertToString(eDataType, instanceValue);
	}
