 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AddLookupTableTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddLookupTableTypeImpl extends MinimalEObjectImpl.Container implements AddLookupTableType {
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.ADD_LOOKUP_TABLE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DbchangelogPackage.ADD_LOOKUP_TABLE_TYPE__ANY_ATTRIBUTE:
