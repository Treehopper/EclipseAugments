...
/**
 * This is the item provider adapter for a {@link org.liquibase.xml.ns.dbchangelog.SqlType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SqlTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SqlType_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SqlType_comment_feature", "_UI_SqlType_type"),
	...
	protected void addDbmsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SqlType_dbms_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SqlType_dbms_feature", "_UI_SqlType_type"),
				 DbchangelogPackage.eINSTANCE.getSqlType_Dbms(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEndDelimiterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SqlType_endDelimiter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SqlType_endDelimiter_feature", "_UI_SqlType_type"),
				 DbchangelogPackage.eINSTANCE.getSqlType_EndDelimiter(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSplitStatementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SqlType_splitStatements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SqlType_splitStatements_feature", "_UI_SqlType_type"),
				 DbchangelogPackage.eINSTANCE.getSqlType_SplitStatements(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStripCommentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SqlType_stripComments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SqlType_stripComments_feature", "_UI_SqlType_type"),
				 DbchangelogPackage.eINSTANCE.getSqlType_StripComments(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getSqlType_Mixed());
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getSqlType_AnyAttribute());
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SqlType"));
	}
	...
	public String getText(Object object) {
		String label = ((SqlType)object).getComment();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SqlType.class)) {
			...
			case DbchangelogPackage.SQL_TYPE__ANY_ATTRIBUTE:
