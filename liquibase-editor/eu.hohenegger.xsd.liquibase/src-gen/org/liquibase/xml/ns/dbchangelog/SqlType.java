 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.SqlType#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
...
public interface SqlType extends EObject {
	 ...
	 * @see org.liquibase.xml.ns.dbchangelog.DbchangelogPackage#getSqlType_AnyAttribute()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
