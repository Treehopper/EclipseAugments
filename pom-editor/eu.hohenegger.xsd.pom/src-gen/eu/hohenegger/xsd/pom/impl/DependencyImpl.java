 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getType <em>Type</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getClassifier <em>Classifier</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getSystemPath <em>System Path</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getExclusions <em>Exclusions</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyImpl#getOptional <em>Optional</em>}</li>
 * </ul>
 *
 * @generated
 */
