...
/**
 * This is the item provider adapter for a {@link org.liquibase.xml.ns.dbchangelog.RenameViewType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RenameViewTypeItemProvider 
	 ...
	 * @generated
	 */
	public RenameViewTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNewViewNamePropertyDescriptor(object);
			addOldViewNamePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the New View Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNewViewNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RenameViewType_newViewName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RenameViewType_newViewName_feature", "_UI_RenameViewType_type"),
				 DbchangelogPackage.eINSTANCE.getRenameViewType_NewViewName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSchemaNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RenameViewType_schemaName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RenameViewType_schemaName_feature", "_UI_RenameViewType_type"),
				 DbchangelogPackage.eINSTANCE.getRenameViewType_SchemaName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getRenameViewType_AnyAttribute());
		}
	...
	/**
	 * This returns RenameViewType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RenameViewType"));
	}
	...
	public String getText(Object object) {
		String label = ((RenameViewType)object).getCatalogName();
		return label == null || label.length() == 0 ?
			getString("_UI_RenameViewType_type") :
			getString("_UI_RenameViewType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RenameViewType.class)) {
