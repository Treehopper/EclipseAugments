...
public class AddNotNullConstraintTypeItemProvider 
	...
	protected void addConstraintNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AddNotNullConstraintType_constraintName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AddNotNullConstraintType_constraintName_feature", "_UI_AddNotNullConstraintType_type"),
				 DbchangelogPackage.eINSTANCE.getAddNotNullConstraintType_ConstraintName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getAddNotNullConstraintType_AnyAttribute());
		}
