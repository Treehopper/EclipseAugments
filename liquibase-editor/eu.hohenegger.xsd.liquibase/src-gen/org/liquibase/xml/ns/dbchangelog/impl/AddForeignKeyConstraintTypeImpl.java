 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AddForeignKeyConstraintTypeImpl#getValidate <em>Validate</em>}</li>
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AddForeignKeyConstraintTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddForeignKeyConstraintTypeImpl extends MinimalEObjectImpl.Container implements AddForeignKeyConstraintType {
	...
	public void setValidate(Object newValidate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.ADD_FOREIGN_KEY_CONSTRAINT_TYPE__VALIDATE, oldValidate, validate));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.ADD_FOREIGN_KEY_CONSTRAINT_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DbchangelogPackage.ADD_FOREIGN_KEY_CONSTRAINT_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DbchangelogPackage.ADD_FOREIGN_KEY_CONSTRAINT_TYPE__VALIDATE:
				return getValidate();
			case DbchangelogPackage.ADD_FOREIGN_KEY_CONSTRAINT_TYPE__ANY_ATTRIBUTE:
