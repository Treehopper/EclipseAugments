 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.AddAutoIncrementTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddAutoIncrementTypeImpl extends MinimalEObjectImpl.Container implements AddAutoIncrementType {
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.ADD_AUTO_INCREMENT_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DbchangelogPackage.ADD_AUTO_INCREMENT_TYPE__ANY_ATTRIBUTE:
