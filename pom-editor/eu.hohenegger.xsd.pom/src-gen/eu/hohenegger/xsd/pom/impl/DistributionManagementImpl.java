 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DistributionManagementImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DistributionManagementImpl#getSnapshotRepository <em>Snapshot Repository</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DistributionManagementImpl#getSite <em>Site</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DistributionManagementImpl#getDownloadUrl <em>Download Url</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DistributionManagementImpl#getRelocation <em>Relocation</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DistributionManagementImpl#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DistributionManagementImpl extends MinimalEObjectImpl.Container implements DistributionManagement {
	/**
