...
public class DropSequenceTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DropSequenceType_cacheSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DropSequenceType_cacheSize_feature", "_UI_DropSequenceType_type"),
				 DbchangelogPackage.eINSTANCE.getDropSequenceType_CacheSize(),
				 true,
				 false,
				 false,
	...
	protected void addCyclePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DropSequenceType_cycle_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DropSequenceType_cycle_feature", "_UI_DropSequenceType_type"),
				 DbchangelogPackage.eINSTANCE.getDropSequenceType_Cycle(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getDropSequenceType_AnyAttribute());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DropSequenceType.class)) {
			...
			case DbchangelogPackage.DROP_SEQUENCE_TYPE__START_VALUE:
				...
				return;
			case DbchangelogPackage.DROP_SEQUENCE_TYPE__ANY_ATTRIBUTE:
