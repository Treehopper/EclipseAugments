 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.DropForeignKeyConstraintTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DropForeignKeyConstraintTypeImpl extends MinimalEObjectImpl.Container implements DropForeignKeyConstraintType {
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.DROP_FOREIGN_KEY_CONSTRAINT_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DbchangelogPackage.DROP_FOREIGN_KEY_CONSTRAINT_TYPE__ANY_ATTRIBUTE:
