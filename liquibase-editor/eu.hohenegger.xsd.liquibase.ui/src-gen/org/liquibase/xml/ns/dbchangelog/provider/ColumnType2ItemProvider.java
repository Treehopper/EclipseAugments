...
public class ColumnType2ItemProvider 
	...
	protected void addComputedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType2_computed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType2_computed_feature", "_UI_ColumnType2_type"),
				 DbchangelogPackage.eINSTANCE.getColumnType2_Computed(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDefaultValueConstraintNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType2_defaultValueConstraintName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType2_defaultValueConstraintName_feature", "_UI_ColumnType2_type"),
				 DbchangelogPackage.eINSTANCE.getColumnType2_DefaultValueConstraintName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDescendingPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ColumnType2_descending_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ColumnType2_descending_feature", "_UI_ColumnType2_type"),
				 DbchangelogPackage.eINSTANCE.getColumnType2_Descending(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getColumnType2_AnyAttribute());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ColumnType2.class)) {
			...
			case DbchangelogPackage.COLUMN_TYPE2__DEFAULT_VALUE_CONSTRAINT_NAME:
			...
			case DbchangelogPackage.COLUMN_TYPE2__DESCENDING:
