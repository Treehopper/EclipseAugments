 ...
 * @generated
 */
public class ExtensionsSwitch<T1> extends Switch<T1> {
	/**
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExtensionsPackage.WIZARD: {
				Wizard wizard = (Wizard)theEObject;
				T1 result = caseWizard(wizard);
				if (result == null) result = caseContribution(wizard);
				if (result == null) result = caseWindow(wizard);
				...
				if (result == null) result = caseContext(wizard);
				if (result == null) result = caseHandlerContainer(wizard);
				if (result == null) result = caseBindings(wizard);
				if (result == null) result = caseSnippetContainer(wizard);
				if (result == null) result = caseUIElement(wizard);
				if (result == null) result = caseLocalizable(wizard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionsPackage.WIZARD_PAGE: {
				WizardPage wizardPage = (WizardPage)theEObject;
				T1 result = caseWizardPage(wizardPage);
				if (result == null) result = caseUIElement(wizardPage);
				if (result == null) result = caseContribution(wizardPage);
				if (result == null) result = caseApplicationElement(wizardPage);
				if (result == null) result = caseLocalizable(wizardPage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionsPackage.DYNAMIC_WIZARD_PAGE: {
				DynamicWizardPage dynamicWizardPage = (DynamicWizardPage)theEObject;
				T1 result = caseDynamicWizardPage(dynamicWizardPage);
				if (result == null) result = caseWizardPage(dynamicWizardPage);
				if (result == null) result = caseUIElement(dynamicWizardPage);
				if (result == null) result = caseContribution(dynamicWizardPage);
				if (result == null) result = caseApplicationElement(dynamicWizardPage);
				if (result == null) result = caseLocalizable(dynamicWizardPage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExtensionsPackage.WIZARD_FINISHER: {
				WizardFinisher wizardFinisher = (WizardFinisher)theEObject;
				T1 result = caseWizardFinisher(wizardFinisher);
				if (result == null) result = caseContribution(wizardFinisher);
				if (result == null) result = caseApplicationElement(wizardFinisher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T1 caseWizard(Wizard object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseWizardPage(WizardPage object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dynamic Wizard Page</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dynamic Wizard Page</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseDynamicWizardPage(DynamicWizardPage object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Wizard Finisher</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Wizard Finisher</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseWizardFinisher(WizardFinisher object) {
		return null;
	}
