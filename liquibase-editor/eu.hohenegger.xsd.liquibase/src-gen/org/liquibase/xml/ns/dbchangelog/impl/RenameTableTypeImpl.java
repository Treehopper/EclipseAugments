 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.RenameTableTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RenameTableTypeImpl extends MinimalEObjectImpl.Container implements RenameTableType {
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.RENAME_TABLE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
