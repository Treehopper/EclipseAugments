 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependencyManagementImpl#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependencyManagementImpl extends MinimalEObjectImpl.Container implements DependencyManagement {
	...
	public NotificationChain basicSetDependencies(DependenciesType3 newDependencies, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.DEPENDENCY_MANAGEMENT__DEPENDENCIES, oldDependencies, newDependencies);
	...
	public void setDependencies(DependenciesType3 newDependencies) {
		if (newDependencies != dependencies) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.DEPENDENCY_MANAGEMENT__DEPENDENCIES, newDependencies, newDependencies));
	}
