...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.RESOURCE__TARGET_PATH,
				 true,
				 false,
				 false,
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.RESOURCE__INCLUDES,
				 PomFactory.eINSTANCE.createIncludesType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.RESOURCE__EXCLUDES,
				 PomFactory.eINSTANCE.createExcludesType()));
	}
