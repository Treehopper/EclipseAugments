 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependenciesTypeImpl#getDependency <em>Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependenciesTypeImpl extends MinimalEObjectImpl.Container implements DependenciesType {
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, PomPackage.DEPENDENCIES_TYPE__DEPENDENCY);
		}
		return dependency;
	}
