...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.RepositoryPolicy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryPolicyItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RepositoryPolicy_enabled_feature", "_UI_RepositoryPolicy_type"),
				 PomPackage.Literals.REPOSITORY_POLICY__ENABLED,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RepositoryPolicy_updatePolicy_feature", "_UI_RepositoryPolicy_type"),
				 PomPackage.Literals.REPOSITORY_POLICY__UPDATE_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_RepositoryPolicy_checksumPolicy_feature", "_UI_RepositoryPolicy_type"),
				 PomPackage.Literals.REPOSITORY_POLICY__CHECKSUM_POLICY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns RepositoryPolicy.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_RepositoryPolicy_type") :
