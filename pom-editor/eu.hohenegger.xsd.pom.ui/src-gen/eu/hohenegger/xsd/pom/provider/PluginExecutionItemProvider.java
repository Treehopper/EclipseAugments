...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.PluginExecution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PluginExecutionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.PLUGIN_EXECUTION__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PluginExecution_phase_feature", "_UI_PluginExecution_type"),
				 PomPackage.Literals.PLUGIN_EXECUTION__PHASE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_PluginExecution_inherited_feature", "_UI_PluginExecution_type"),
				 PomPackage.Literals.PLUGIN_EXECUTION__INHERITED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PomPackage.Literals.PLUGIN_EXECUTION__CONFIGURATION);
		}
	...
	/**
	 * This returns PluginExecution.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_PluginExecution_type") :
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PLUGIN_EXECUTION__GOALS,
				 PomFactory.eINSTANCE.createGoalsType1()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PLUGIN_EXECUTION__CONFIGURATION,
				 PomFactory.eINSTANCE.createConfigurationType3()));
	}
