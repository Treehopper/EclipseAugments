 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.SqlFileTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SqlFileTypeImpl extends MinimalEObjectImpl.Container implements SqlFileType {
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, DbchangelogPackage.SQL_FILE_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DbchangelogPackage.SQL_FILE_TYPE__ANY_ATTRIBUTE:
