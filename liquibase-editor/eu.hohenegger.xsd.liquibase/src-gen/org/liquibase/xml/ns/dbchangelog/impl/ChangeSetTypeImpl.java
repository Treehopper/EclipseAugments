...
import org.liquibase.xml.ns.dbchangelog.EmptyType;
 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ChangeSetTypeImpl#getIgnore <em>Ignore</em>}</li>
...
public class ChangeSetTypeImpl extends MinimalEObjectImpl.Container implements ChangeSetType {
	 ...
	 * @ordered
	 */
	protected static final Object IGNORE_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Object ignore = IGNORE_EDEFAULT;
	 ...
	 * @generated
	 */
	public EList<EmptyType> getEmpty() {
	...
	public void setIgnore(Object newIgnore) {
		Object oldIgnore = ignore;
		ignore = newIgnore;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.CHANGE_SET_TYPE__IGNORE, oldIgnore, ignore));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DbchangelogPackage.CHANGE_SET_TYPE__EMPTY:
				getEmpty().clear();
				getEmpty().addAll((Collection<? extends EmptyType>)newValue);
				return;
			case DbchangelogPackage.CHANGE_SET_TYPE__ROLLBACK:
				getRollback().clear();
