	...
	protected void addLabelsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModifySqlType_labels_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModifySqlType_labels_feature", "_UI_ModifySqlType_type"),
				 DbchangelogPackage.eINSTANCE.getModifySqlType_Labels(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
