...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.Profile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PROFILE__MODULES,
				 PomFactory.eINSTANCE.createModulesType()));
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PROFILE__DEPENDENCIES,
				 PomFactory.eINSTANCE.createDependenciesType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PROFILE__REPOSITORIES,
				 PomFactory.eINSTANCE.createRepositoriesType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PROFILE__PLUGIN_REPOSITORIES,
				 PomFactory.eINSTANCE.createPluginRepositoriesType()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.PROFILE__REPORTS,
				 PomFactory.eINSTANCE.createReportsType1()));
