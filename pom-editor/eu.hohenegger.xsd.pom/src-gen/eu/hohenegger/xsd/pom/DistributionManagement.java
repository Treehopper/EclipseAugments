 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.DistributionManagement#getRepository <em>Repository</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.DistributionManagement#getSnapshotRepository <em>Snapshot Repository</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.DistributionManagement#getSite <em>Site</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.DistributionManagement#getDownloadUrl <em>Download Url</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.DistributionManagement#getRelocation <em>Relocation</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.DistributionManagement#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement()
...
public interface DistributionManagement extends EObject {
	 ...
	 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement_Repository()
	...
	/**
	 * Sets the value of the '{@link eu.hohenegger.xsd.pom.DistributionManagement#getRepository <em>Repository</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement_SnapshotRepository()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link eu.hohenegger.xsd.pom.DistributionManagement#getSnapshotRepository <em>Snapshot Repository</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setSite(Site)
	 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement_Site()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link eu.hohenegger.xsd.pom.DistributionManagement#getSite <em>Site</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement_DownloadUrl()
	...
	/**
	 * Sets the value of the '{@link eu.hohenegger.xsd.pom.DistributionManagement#getDownloadUrl <em>Download Url</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement_Relocation()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link eu.hohenegger.xsd.pom.DistributionManagement#getRelocation <em>Relocation</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see eu.hohenegger.xsd.pom.PomPackage#getDistributionManagement_Status()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link eu.hohenegger.xsd.pom.DistributionManagement#getStatus <em>Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
