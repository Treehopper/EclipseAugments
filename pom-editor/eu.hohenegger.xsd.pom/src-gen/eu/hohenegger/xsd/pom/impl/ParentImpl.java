 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ParentImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ParentImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ParentImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ParentImpl#getRelativePath <em>Relative Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParentImpl extends MinimalEObjectImpl.Container implements Parent {
	...
	public void setRelativePath(String newRelativePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.PARENT__RELATIVE_PATH, oldRelativePath, relativePath, !oldRelativePathESet));
	}
	...
	public void unsetRelativePath() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PomPackage.PARENT__RELATIVE_PATH, oldRelativePath, RELATIVE_PATH_EDEFAULT, oldRelativePathESet));
	}
