...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.DeploymentRepository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeploymentRepositoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.DEPLOYMENT_REPOSITORY__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.DEPLOYMENT_REPOSITORY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.DEPLOYMENT_REPOSITORY__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.DEPLOYMENT_REPOSITORY__LAYOUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PomPackage.Literals.DEPLOYMENT_REPOSITORY__RELEASES);
			childrenFeatures.add(PomPackage.Literals.DEPLOYMENT_REPOSITORY__SNAPSHOTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.DEPLOYMENT_REPOSITORY__RELEASES,
				 PomFactory.eINSTANCE.createRepositoryPolicy()));

		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.DEPLOYMENT_REPOSITORY__SNAPSHOTS,
				 PomFactory.eINSTANCE.createRepositoryPolicy()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == PomPackage.Literals.DEPLOYMENT_REPOSITORY__RELEASES ||
			childFeature == PomPackage.Literals.DEPLOYMENT_REPOSITORY__SNAPSHOTS;
