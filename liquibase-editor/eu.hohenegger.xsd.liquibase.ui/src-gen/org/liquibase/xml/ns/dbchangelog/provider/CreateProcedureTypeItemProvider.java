...
public class CreateProcedureTypeItemProvider 
	...
	protected void addReplaceIfExistsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CreateProcedureType_replaceIfExists_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CreateProcedureType_replaceIfExists_feature", "_UI_CreateProcedureType_type"),
				 DbchangelogPackage.eINSTANCE.getCreateProcedureType_ReplaceIfExists(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getCreateProcedureType_AnyAttribute());
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CreateProcedureType.class)) {
			...
			case DbchangelogPackage.CREATE_PROCEDURE_TYPE__ANY_ATTRIBUTE:
