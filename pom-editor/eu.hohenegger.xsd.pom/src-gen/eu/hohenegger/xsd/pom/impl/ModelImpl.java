 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getModelVersion <em>Model Version</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getPackaging <em>Packaging</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getName <em>Name</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getUrl <em>Url</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getInceptionYear <em>Inception Year</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getLicenses <em>Licenses</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getDevelopers <em>Developers</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getContributors <em>Contributors</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getMailingLists <em>Mailing Lists</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getPrerequisites <em>Prerequisites</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getScm <em>Scm</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getIssueManagement <em>Issue Management</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getCiManagement <em>Ci Management</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getDistributionManagement <em>Distribution Management</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getDependencyManagement <em>Dependency Management</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getRepositories <em>Repositories</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getPluginRepositories <em>Plugin Repositories</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getBuild <em>Build</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getReports <em>Reports</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getReporting <em>Reporting</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getProfiles <em>Profiles</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ModelImpl#getChildProjectUrlInheritAppendPath <em>Child Project Url Inherit Append Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	/**
	 * The default value of the '{@link #getChildProjectUrlInheritAppendPath() <em>Child Project Url Inherit Append Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String CHILD_PROJECT_URL_INHERIT_APPEND_PATH_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getChildProjectUrlInheritAppendPath() <em>Child Project Url Inherit Append Path</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getChildProjectUrlInheritAppendPath()
	 * @generated
	 * @ordered
	 */
	protected String childProjectUrlInheritAppendPath = CHILD_PROJECT_URL_INHERIT_APPEND_PATH_EDEFAULT;
	 ...
	 */
	@Override
	public void setChildProjectUrlInheritAppendPath(String newChildProjectUrlInheritAppendPath) {
		String oldChildProjectUrlInheritAppendPath = childProjectUrlInheritAppendPath;
		childProjectUrlInheritAppendPath = newChildProjectUrlInheritAppendPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.MODEL__CHILD_PROJECT_URL_INHERIT_APPEND_PATH, oldChildProjectUrlInheritAppendPath, childProjectUrlInheritAppendPath));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PomPackage.MODEL__PROFILES:
				return getProfiles();
			case PomPackage.MODEL__CHILD_PROJECT_URL_INHERIT_APPEND_PATH:
				return getChildProjectUrlInheritAppendPath();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PomPackage.MODEL__PROFILES:
				...
				return;
			case PomPackage.MODEL__CHILD_PROJECT_URL_INHERIT_APPEND_PATH:
				setChildProjectUrlInheritAppendPath((String)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case PomPackage.MODEL__PROFILES:
				...
				return;
			case PomPackage.MODEL__CHILD_PROJECT_URL_INHERIT_APPEND_PATH:
				setChildProjectUrlInheritAppendPath(CHILD_PROJECT_URL_INHERIT_APPEND_PATH_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case PomPackage.MODEL__CHILD_PROJECT_URL_INHERIT_APPEND_PATH:
				return CHILD_PROJECT_URL_INHERIT_APPEND_PATH_EDEFAULT == null ? childProjectUrlInheritAppendPath != null : !CHILD_PROJECT_URL_INHERIT_APPEND_PATH_EDEFAULT.equals(childProjectUrlInheritAppendPath);
		}
	...
	public String toString() {
		...
		result.append(inceptionYear);
		result.append(", childProjectUrlInheritAppendPath: ");
		result.append(childProjectUrlInheritAppendPath);
		result.append(')');
