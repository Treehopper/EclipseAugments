 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.DependenciesType1Impl#getDependency <em>Dependency</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DependenciesType1Impl extends MinimalEObjectImpl.Container implements DependenciesType1 {
	/**
	...
	protected EClass eStaticClass() {
		return PomPackage.Literals.DEPENDENCIES_TYPE1;
	}
	...
	public EList<Dependency> getDependency() {
		if (dependency == null) {
			dependency = new EObjectContainmentEList<Dependency>(Dependency.class, this, PomPackage.DEPENDENCIES_TYPE1__DEPENDENCY);
		}
		return dependency;
	}
