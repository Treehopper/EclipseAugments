...
/**
 * This is the item provider adapter for a {@link eu.hohenegger.xsd.pom.CiManagement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CiManagementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.CI_MANAGEMENT__SYSTEM,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PomPackage.Literals.CI_MANAGEMENT__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CiManagement_type") :
		...
		newChildDescriptors.add
			(createChildParameter
				(PomPackage.Literals.CI_MANAGEMENT__NOTIFIERS,
				 PomFactory.eINSTANCE.createNotifiersType()));
	}
