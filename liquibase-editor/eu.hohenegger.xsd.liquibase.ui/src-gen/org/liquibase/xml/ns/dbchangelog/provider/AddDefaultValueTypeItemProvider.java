...
public class AddDefaultValueTypeItemProvider 
	...
	protected void addDefaultValueConstraintNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AddDefaultValueType_defaultValueConstraintName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AddDefaultValueType_defaultValueConstraintName_feature", "_UI_AddDefaultValueType_type"),
				 DbchangelogPackage.eINSTANCE.getAddDefaultValueType_DefaultValueConstraintName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getAddDefaultValueType_AnyAttribute());
		}
