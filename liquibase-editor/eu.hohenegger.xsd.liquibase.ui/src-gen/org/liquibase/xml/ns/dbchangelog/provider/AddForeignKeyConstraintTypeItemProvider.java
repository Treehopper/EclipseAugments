...
public class AddForeignKeyConstraintTypeItemProvider 
	...
	protected void addValidatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AddForeignKeyConstraintType_validate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AddForeignKeyConstraintType_validate_feature", "_UI_AddForeignKeyConstraintType_type"),
				 DbchangelogPackage.eINSTANCE.getAddForeignKeyConstraintType_Validate(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DbchangelogPackage.eINSTANCE.getAddForeignKeyConstraintType_AnyAttribute());
		}
