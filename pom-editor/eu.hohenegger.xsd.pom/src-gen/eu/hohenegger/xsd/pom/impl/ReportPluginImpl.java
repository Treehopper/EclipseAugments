 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ReportPluginImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ReportPluginImpl#getArtifactId <em>Artifact Id</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ReportPluginImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ReportPluginImpl#getReportSets <em>Report Sets</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ReportPluginImpl#getInherited <em>Inherited</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.ReportPluginImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReportPluginImpl extends MinimalEObjectImpl.Container implements ReportPlugin {
	/**
	...
	public NotificationChain basicSetReportSets(ReportSetsType newReportSets, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.REPORT_PLUGIN__REPORT_SETS, oldReportSets, newReportSets);
	...
	public void setReportSets(ReportSetsType newReportSets) {
		if (newReportSets != reportSets) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.REPORT_PLUGIN__REPORT_SETS, newReportSets, newReportSets));
	}
	...
	public NotificationChain basicSetConfiguration(ConfigurationType1 newConfiguration, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PomPackage.REPORT_PLUGIN__CONFIGURATION, oldConfiguration, newConfiguration);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConfiguration(ConfigurationType1 newConfiguration) {
		if (newConfiguration != configuration) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PomPackage.REPORT_PLUGIN__CONFIGURATION, newConfiguration, newConfiguration));
	}
