 ...
 * </p>
 * <ul>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getSourceDirectory <em>Source Directory</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getScriptSourceDirectory <em>Script Source Directory</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getTestSourceDirectory <em>Test Source Directory</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getOutputDirectory <em>Output Directory</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getTestOutputDirectory <em>Test Output Directory</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getExtensions <em>Extensions</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getDefaultGoal <em>Default Goal</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getTestResources <em>Test Resources</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getDirectory <em>Directory</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getFinalName <em>Final Name</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getFilters <em>Filters</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getPluginManagement <em>Plugin Management</em>}</li>
 *   <li>{@link eu.hohenegger.xsd.pom.impl.BuildImpl#getPlugins <em>Plugins</em>}</li>
 * </ul>
 *
 * @generated
 */
