 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnType2Impl#getDefaultValueConstraintName <em>Default Value Constraint Name</em>}</li>
 ...
 *   <li>{@link org.liquibase.xml.ns.dbchangelog.impl.ColumnType2Impl#getDescending <em>Descending</em>}</li>
...
public class ColumnType2Impl extends MinimalEObjectImpl.Container implements ColumnType2 {
	...
	public void setDefaultValueConstraintName(String newDefaultValueConstraintName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE2__DEFAULT_VALUE_CONSTRAINT_NAME, oldDefaultValueConstraintName, defaultValueConstraintName));
	}
	...
	public void setDescending(Object newDescending) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DbchangelogPackage.COLUMN_TYPE2__DESCENDING, oldDescending, descending));
	}
